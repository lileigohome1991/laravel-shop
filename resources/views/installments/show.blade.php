            ...
            <div class="installment-next text-right">
              ...
              @else
                ...
                <div class="payment-buttons">
                  ...
                  <a class="btn btn-primary btn-sm" href="{{ route('payment.installments.alipay', ['installment' => $installment->id]) }}">支付宝支付</a>
                  <!-- <button class="btn btn-sm btn-success" id='btn-wechat'>微信支付</button> -->
                  <a class="btn btn-success btn-sm" href="{{ route('payment.installments.wechat', ['installment' => $installment->id]) }}">微信支付</a>
...
<script>
  $(document).ready(function() {
    $('#btn-wechat').click(function() {
      swal({
        content: $('<img src="{{ route('payment.installments.wechat', ['installment' => $installment->id]) }}" />')[0],
