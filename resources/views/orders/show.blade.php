...
<!-- 分期弹框开始 -->
<div class="modal fade" id="installment-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">选择分期期数</h5>
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped text-center">
          ...
          <tr>
              ...
              <td>10%</td>
              <td>
                <button class="btn btn-sm btn-primary btn-select-installment" data-count="2">选择</button>
              </td>
            </tr>
          </tbody>
        </table>
